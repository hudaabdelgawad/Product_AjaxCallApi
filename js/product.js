...
let proId;
let UrlPro = 'https://localhost:7055/api/Products';
...
CountProduct = () => {
    ...
    Helper.AjaxCallGet(UrlPro, (data) => {
        ...
        if (data != null) {
            countpro.innerHTML = `-TotalPro (${data.length})`;
        }
    });
...
//ShowTable();   document.readyبتعمل ايرور بديلها ال 
